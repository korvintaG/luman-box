...
— Как ты сказал?
— Он остановил тебя своей волей.' , 'Человек знания может остановить волей другого человека. вмешавшись в ход его мыслей и во внутренний диалог.', (select id from users where id_out='korvintag_6'), to_timestamp( '31.08.2023 10:40:32', 'DD.MM.YYYY HH24:MI:SS') where not exists (select * from sources where id_out='korvintag_2505');
