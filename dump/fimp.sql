...
insert into authors (name, id_out, user_id, moderated) select 'Зонке Аренс' , 'korvintag_1', (select id from users where id_out='korvintag_1'), (select id from users where id_out='korvintag_1') where not exists (select * from authors where id_out='korvintag_1');
update authors set name='Зонке Аренс' where id_out='korvintag_1';
insert into authors (name, id_out, user_id, moderated) select 'Кастанеда Карлос' , 'korvintag_6', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from authors where id_out='korvintag_6');
update authors set name='Кастанеда Карлос' where id_out='korvintag_6';
insert into authors (name, id_out, user_id, moderated) select 'Харгадон Эндрю' , 'korvintag_19', (select id from users where id_out='korvintag_19'), (select id from users where id_out='korvintag_19') where not exists (select * from authors where id_out='korvintag_19');
update authors set name='Харгадон Эндрю' where id_out='korvintag_19';
insert into authors (name, id_out, user_id, moderated) select 'Гуревич Павел Семенович' , 'korvintag_21', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from authors where id_out='korvintag_21');
update authors set name='Гуревич Павел Семенович' where id_out='korvintag_21';
insert into authors (name, id_out, user_id, moderated) select 'Лоулесс Джим' , 'korvintag_24', (select id from users where id_out='korvintag_24'), (select id from users where id_out='korvintag_24') where not exists (select * from authors where id_out='korvintag_24');
update authors set name='Лоулесс Джим' where id_out='korvintag_24';
insert into authors (name, id_out, user_id, moderated) select 'Пелевин Виктор' , 'korvintag_30', (select id from users where id_out='korvintag_30'), (select id from users where id_out='korvintag_30') where not exists (select * from authors where id_out='korvintag_30');
update authors set name='Пелевин Виктор' where id_out='korvintag_30';
insert into authors (name, id_out, user_id, moderated) select 'Щепетнов Евгений' , 'korvintag_40', (select id from users where id_out='korvintag_40'), (select id from users where id_out='korvintag_40') where not exists (select * from authors where id_out='korvintag_40');
update authors set name='Щепетнов Евгений' where id_out='korvintag_40';
insert into authors (name, id_out, user_id, moderated) select 'Поварнин Сергей' , 'korvintag_41', (select id from users where id_out='korvintag_1'), (select id from users where id_out='korvintag_1') where not exists (select * from authors where id_out='korvintag_41');
update authors set name='Поварнин Сергей' where id_out='korvintag_41';
insert into authors (name, id_out, user_id, moderated) select 'Дас Сатья' , 'korvintag_45', (select id from users where id_out='korvintag_45'), (select id from users where id_out='korvintag_45') where not exists (select * from authors where id_out='korvintag_45');
update authors set name='Дас Сатья' where id_out='korvintag_45';
insert into authors (name, id_out, user_id, moderated) select 'Мужицкая Татьяна' , 'korvintag_57', (select id from users where id_out='korvintag_57'), (select id from users where id_out='korvintag_57') where not exists (select * from authors where id_out='korvintag_57');
update authors set name='Мужицкая Татьяна' where id_out='korvintag_57';
insert into authors (name, id_out, user_id, moderated) select 'Шабанов Сергей' , 'korvintag_106', (select id from users where id_out='korvintag_24'), (select id from users where id_out='korvintag_24') where not exists (select * from authors where id_out='korvintag_106');
update authors set name='Шабанов Сергей' where id_out='korvintag_106';
insert into authors (name, id_out, user_id, moderated) select 'Толле Экхарт' , 'korvintag_109', (select id from users where id_out='korvintag_109'), (select id from users where id_out='korvintag_109') where not exists (select * from authors where id_out='korvintag_109');
update authors set name='Толле Экхарт' where id_out='korvintag_109';
insert into authors (name, id_out, user_id, moderated) select 'Синсеро Джен' , 'korvintag_113', (select id from users where id_out='korvintag_24'), (select id from users where id_out='korvintag_24') where not exists (select * from authors where id_out='korvintag_113');
update authors set name='Синсеро Джен' where id_out='korvintag_113';
insert into authors (name, id_out, user_id, moderated) select 'Ошо' , 'korvintag_115', (select id from users where id_out='korvintag_109'), (select id from users where id_out='korvintag_109') where not exists (select * from authors where id_out='korvintag_115');
update authors set name='Ошо' where id_out='korvintag_115';
insert into authors (name, id_out, user_id, moderated) select 'Чалдини Роберт' , 'korvintag_120', (select id from users where id_out='korvintag_24'), (select id from users where id_out='korvintag_24') where not exists (select * from authors where id_out='korvintag_120');
update authors set name='Чалдини Роберт' where id_out='korvintag_120';
insert into authors (name, id_out, user_id, moderated) select 'Клир Джеймс' , 'korvintag_121', (select id from users where id_out='korvintag_24'), (select id from users where id_out='korvintag_24') where not exists (select * from authors where id_out='korvintag_121');
update authors set name='Клир Джеймс' where id_out='korvintag_121';
insert into authors (name, id_out, user_id, moderated) select 'Новых Анастасия' , 'korvintag_125', (select id from users where id_out='korvintag_85'), (select id from users where id_out='korvintag_85') where not exists (select * from authors where id_out='korvintag_125');
update authors set name='Новых Анастасия' where id_out='korvintag_125';
insert into authors (name, id_out, user_id, moderated) select 'Сакс Оливер' , 'korvintag_130', (select id from users where id_out='korvintag_57'), (select id from users where id_out='korvintag_57') where not exists (select * from authors where id_out='korvintag_130');
update authors set name='Сакс Оливер' where id_out='korvintag_130';
insert into authors (name, id_out, user_id, moderated) select 'Элленхорн Росс' , 'korvintag_131', (select id from users where id_out='korvintag_24'), (select id from users where id_out='korvintag_24') where not exists (select * from authors where id_out='korvintag_131');
update authors set name='Элленхорн Росс' where id_out='korvintag_131';
insert into authors (name, id_out, user_id, moderated) select 'Гуленко Виктор' , 'korvintag_139', (select id from users where id_out='korvintag_139'), (select id from users where id_out='korvintag_139') where not exists (select * from authors where id_out='korvintag_139');
update authors set name='Гуленко Виктор' where id_out='korvintag_139';
insert into authors (name, id_out, user_id, moderated) select 'Грин Роберт' , 'korvintag_140', (select id from users where id_out='korvintag_140'), (select id from users where id_out='korvintag_140') where not exists (select * from authors where id_out='korvintag_140');
update authors set name='Грин Роберт' where id_out='korvintag_140';
insert into keywords (name, id_out, user_id, moderated) select 'Противоречие' , 'korvintag_2', (select id from users where id_out='korvintag_1'), (select id from users where id_out='korvintag_1') where not exists (select * from keywords where id_out='korvintag_2');
update keywords set name='Противоречие' where id_out='korvintag_2';
insert into keywords (name, id_out, user_id, moderated) select 'Понимание' , 'korvintag_11', (select id from users where id_out='korvintag_1'), (select id from users where id_out='korvintag_1') where not exists (select * from keywords where id_out='korvintag_11');
update keywords set name='Понимание' where id_out='korvintag_11';
insert into keywords (name, id_out, user_id, moderated) select 'Ошибки' , 'korvintag_36', (select id from users where id_out='korvintag_1'), (select id from users where id_out='korvintag_1') where not exists (select * from keywords where id_out='korvintag_36');
update keywords set name='Ошибки' where id_out='korvintag_36';
insert into keywords (name, id_out, user_id, moderated) select 'Решение (процесс принятия)' , 'korvintag_42', (select id from users where id_out='korvintag_1'), (select id from users where id_out='korvintag_1') where not exists (select * from keywords where id_out='korvintag_42');
update keywords set name='Решение (процесс принятия)' where id_out='korvintag_42';
insert into keywords (name, id_out, user_id, moderated) select 'Привычки' , 'korvintag_52', (select id from users where id_out='korvintag_1'), (select id from users where id_out='korvintag_1') where not exists (select * from keywords where id_out='korvintag_52');
update keywords set name='Привычки' where id_out='korvintag_52';
insert into keywords (name, id_out, user_id, moderated) select 'Сомнение' , 'korvintag_62', (select id from users where id_out='korvintag_1'), (select id from users where id_out='korvintag_1') where not exists (select * from keywords where id_out='korvintag_62');
update keywords set name='Сомнение' where id_out='korvintag_62';
insert into keywords (name, id_out, user_id, moderated) select 'Глупость' , 'korvintag_63', (select id from users where id_out='korvintag_1'), (select id from users where id_out='korvintag_1') where not exists (select * from keywords where id_out='korvintag_63');
update keywords set name='Глупость' where id_out='korvintag_63';
insert into keywords (name, id_out, user_id, moderated) select 'Успех' , 'korvintag_70', (select id from users where id_out='korvintag_1'), (select id from users where id_out='korvintag_1') where not exists (select * from keywords where id_out='korvintag_70');
update keywords set name='Успех' where id_out='korvintag_70';
insert into keywords (name, id_out, user_id, moderated) select 'Сопротивление' , 'korvintag_76', (select id from users where id_out='korvintag_1'), (select id from users where id_out='korvintag_1') where not exists (select * from keywords where id_out='korvintag_76');
update keywords set name='Сопротивление' where id_out='korvintag_76';
insert into keywords (name, id_out, user_id, moderated) select 'ЧСВ' , 'korvintag_83', (select id from users where id_out='korvintag_57'), (select id from users where id_out='korvintag_57') where not exists (select * from keywords where id_out='korvintag_83');
update keywords set name='ЧСВ' where id_out='korvintag_83';
insert into keywords (name, id_out, user_id, moderated) select 'Цель' , 'korvintag_106', (select id from users where id_out='korvintag_1'), (select id from users where id_out='korvintag_1') where not exists (select * from keywords where id_out='korvintag_106');
update keywords set name='Цель' where id_out='korvintag_106';
insert into keywords (name, id_out, user_id, moderated) select 'Путь (дао)' , 'korvintag_126', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_126');
update keywords set name='Путь (дао)' where id_out='korvintag_126';
insert into keywords (name, id_out, user_id, moderated) select 'Мистика' , 'korvintag_288', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_288');
update keywords set name='Мистика' where id_out='korvintag_288';
insert into keywords (name, id_out, user_id, moderated) select 'Смерть' , 'korvintag_297', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_297');
update keywords set name='Смерть' where id_out='korvintag_297';
insert into keywords (name, id_out, user_id, moderated) select 'Условности восприятия' , 'korvintag_298', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_298');
update keywords set name='Условности восприятия' where id_out='korvintag_298';
insert into keywords (name, id_out, user_id, moderated) select 'Восприятие' , 'korvintag_299', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_299');
update keywords set name='Восприятие' where id_out='korvintag_299';
insert into keywords (name, id_out, user_id, moderated) select 'Сталкинг' , 'korvintag_302', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_302');
update keywords set name='Сталкинг' where id_out='korvintag_302';
insert into keywords (name, id_out, user_id, moderated) select 'Сновидение' , 'korvintag_303', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_303');
update keywords set name='Сновидение' where id_out='korvintag_303';
insert into keywords (name, id_out, user_id, moderated) select 'ЛГБТ-движение' , 'korvintag_304', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_304');
update keywords set name='ЛГБТ-движение' where id_out='korvintag_304';
insert into keywords (name, id_out, user_id, moderated) select 'Тело человека' , 'korvintag_305', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_305');
update keywords set name='Тело человека' where id_out='korvintag_305';
insert into keywords (name, id_out, user_id, moderated) select 'Нагваль' , 'korvintag_307', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_307');
update keywords set name='Нагваль' where id_out='korvintag_307';
insert into keywords (name, id_out, user_id, moderated) select 'Место силы' , 'korvintag_311', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_311');
update keywords set name='Место силы' where id_out='korvintag_311';
insert into keywords (name, id_out, user_id, moderated) select 'Страх' , 'korvintag_368', (select id from users where id_out='korvintag_24'), (select id from users where id_out='korvintag_24') where not exists (select * from keywords where id_out='korvintag_368');
update keywords set name='Страх' where id_out='korvintag_368';
insert into keywords (name, id_out, user_id, moderated) select 'Враг' , 'korvintag_386', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_386');
update keywords set name='Враг' where id_out='korvintag_386';
insert into keywords (name, id_out, user_id, moderated) select 'Внутренний диалог' , 'korvintag_417', (select id from users where id_out='korvintag_30'), (select id from users where id_out='korvintag_30') where not exists (select * from keywords where id_out='korvintag_417');
update keywords set name='Внутренний диалог' where id_out='korvintag_417';
insert into keywords (name, id_out, user_id, moderated) select 'Фокусировка внимания' , 'korvintag_574', (select id from users where id_out='korvintag_1'), (select id from users where id_out='korvintag_1') where not exists (select * from keywords where id_out='korvintag_574');
update keywords set name='Фокусировка внимания' where id_out='korvintag_574';
insert into keywords (name, id_out, user_id, moderated) select 'Сознание' , 'korvintag_590', (select id from users where id_out='korvintag_30'), (select id from users where id_out='korvintag_30') where not exists (select * from keywords where id_out='korvintag_590');
update keywords set name='Сознание' where id_out='korvintag_590';
insert into keywords (name, id_out, user_id, moderated) select 'Важность' , 'korvintag_602', (select id from users where id_out='korvintag_1'), (select id from users where id_out='korvintag_1') where not exists (select * from keywords where id_out='korvintag_602');
update keywords set name='Важность' where id_out='korvintag_602';
insert into keywords (name, id_out, user_id, moderated) select 'Воля' , 'korvintag_687', (select id from users where id_out='korvintag_30'), (select id from users where id_out='korvintag_30') where not exists (select * from keywords where id_out='korvintag_687');
update keywords set name='Воля' where id_out='korvintag_687';
insert into keywords (name, id_out, user_id, moderated) select 'Действие' , 'korvintag_699', (select id from users where id_out='korvintag_1'), (select id from users where id_out='korvintag_1') where not exists (select * from keywords where id_out='korvintag_699');
update keywords set name='Действие' where id_out='korvintag_699';
insert into keywords (name, id_out, user_id, moderated) select 'Проблема' , 'korvintag_838', (select id from users where id_out='korvintag_1'), (select id from users where id_out='korvintag_1') where not exists (select * from keywords where id_out='korvintag_838');
update keywords set name='Проблема' where id_out='korvintag_838';
insert into keywords (name, id_out, user_id, moderated) select 'Необходимость' , 'korvintag_867', (select id from users where id_out='korvintag_1'), (select id from users where id_out='korvintag_1') where not exists (select * from keywords where id_out='korvintag_867');
update keywords set name='Необходимость' where id_out='korvintag_867';
insert into keywords (name, id_out, user_id, moderated) select 'Знание' , 'korvintag_909', (select id from users where id_out='korvintag_1'), (select id from users where id_out='korvintag_1') where not exists (select * from keywords where id_out='korvintag_909');
update keywords set name='Знание' where id_out='korvintag_909';
insert into keywords (name, id_out, user_id, moderated) select 'Сила' , 'korvintag_924', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_924');
update keywords set name='Сила' where id_out='korvintag_924';
insert into keywords (name, id_out, user_id, moderated) select 'Победа' , 'korvintag_950', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_950');
update keywords set name='Победа' where id_out='korvintag_950';
insert into keywords (name, id_out, user_id, moderated) select 'Саморазвитие' , 'korvintag_958', (select id from users where id_out='korvintag_1'), (select id from users where id_out='korvintag_1') where not exists (select * from keywords where id_out='korvintag_958');
update keywords set name='Саморазвитие' where id_out='korvintag_958';
insert into keywords (name, id_out, user_id, moderated) select 'Развитие' , 'korvintag_968', (select id from users where id_out='korvintag_24'), (select id from users where id_out='korvintag_24') where not exists (select * from keywords where id_out='korvintag_968');
update keywords set name='Развитие' where id_out='korvintag_968';
insert into keywords (name, id_out, user_id, moderated) select 'Проигрыш' , 'korvintag_972', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_972');
update keywords set name='Проигрыш' where id_out='korvintag_972';
insert into keywords (name, id_out, user_id, moderated) select 'Механизм' , 'korvintag_983', (select id from users where id_out='korvintag_24'), (select id from users where id_out='korvintag_24') where not exists (select * from keywords where id_out='korvintag_983');
update keywords set name='Механизм' where id_out='korvintag_983';
insert into keywords (name, id_out, user_id, moderated) select 'Суть' , 'korvintag_989', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_989');
update keywords set name='Суть' where id_out='korvintag_989';
insert into keywords (name, id_out, user_id, moderated) select 'Общество' , 'korvintag_998', (select id from users where id_out='korvintag_40'), (select id from users where id_out='korvintag_40') where not exists (select * from keywords where id_out='korvintag_998');
update keywords set name='Общество' where id_out='korvintag_998';
insert into keywords (name, id_out, user_id, moderated) select 'Жизнь' , 'korvintag_1019', (select id from users where id_out='korvintag_1'), (select id from users where id_out='korvintag_1') where not exists (select * from keywords where id_out='korvintag_1019');
update keywords set name='Жизнь' where id_out='korvintag_1019';
insert into keywords (name, id_out, user_id, moderated) select 'Слабость' , 'korvintag_1022', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_1022');
update keywords set name='Слабость' where id_out='korvintag_1022';
insert into keywords (name, id_out, user_id, moderated) select 'Концентрация' , 'korvintag_1027', (select id from users where id_out='korvintag_1'), (select id from users where id_out='korvintag_1') where not exists (select * from keywords where id_out='korvintag_1027');
update keywords set name='Концентрация' where id_out='korvintag_1027';
insert into keywords (name, id_out, user_id, moderated) select 'Человек' , 'korvintag_1031', (select id from users where id_out='korvintag_30'), (select id from users where id_out='korvintag_30') where not exists (select * from keywords where id_out='korvintag_1031');
update keywords set name='Человек' where id_out='korvintag_1031';
insert into keywords (name, id_out, user_id, moderated) select 'Разум' , 'korvintag_1037', (select id from users where id_out='korvintag_1'), (select id from users where id_out='korvintag_1') where not exists (select * from keywords where id_out='korvintag_1037');
update keywords set name='Разум' where id_out='korvintag_1037';
insert into keywords (name, id_out, user_id, moderated) select 'Иллюзия' , 'korvintag_1045', (select id from users where id_out='korvintag_1'), (select id from users where id_out='korvintag_1') where not exists (select * from keywords where id_out='korvintag_1045');
update keywords set name='Иллюзия' where id_out='korvintag_1045';
insert into keywords (name, id_out, user_id, moderated) select 'Бытие' , 'korvintag_1046', (select id from users where id_out='korvintag_109'), (select id from users where id_out='korvintag_109') where not exists (select * from keywords where id_out='korvintag_1046');
update keywords set name='Бытие' where id_out='korvintag_1046';
insert into keywords (name, id_out, user_id, moderated) select 'Результат' , 'korvintag_1118', (select id from users where id_out='korvintag_109'), (select id from users where id_out='korvintag_109') where not exists (select * from keywords where id_out='korvintag_1118');
update keywords set name='Результат' where id_out='korvintag_1118';
insert into keywords (name, id_out, user_id, moderated) select 'Отсутсвие' , 'korvintag_1302', (select id from users where id_out='korvintag_109'), (select id from users where id_out='korvintag_109') where not exists (select * from keywords where id_out='korvintag_1302');
update keywords set name='Отсутсвие' where id_out='korvintag_1302';
insert into keywords (name, id_out, user_id, moderated) select 'Регулярность' , 'korvintag_1326', (select id from users where id_out='korvintag_24'), (select id from users where id_out='korvintag_24') where not exists (select * from keywords where id_out='korvintag_1326');
update keywords set name='Регулярность' where id_out='korvintag_1326';
insert into keywords (name, id_out, user_id, moderated) select 'Усталость' , 'korvintag_1337', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_1337');
update keywords set name='Усталость' where id_out='korvintag_1337';
insert into keywords (name, id_out, user_id, moderated) select 'Преодоление' , 'korvintag_1380', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_1380');
update keywords set name='Преодоление' where id_out='korvintag_1380';
insert into keywords (name, id_out, user_id, moderated) select 'Потенциал' , 'korvintag_1384', (select id from users where id_out='korvintag_24'), (select id from users where id_out='korvintag_24') where not exists (select * from keywords where id_out='korvintag_1384');
update keywords set name='Потенциал' where id_out='korvintag_1384';
insert into keywords (name, id_out, user_id, moderated) select 'Получение' , 'korvintag_1419', (select id from users where id_out='korvintag_109'), (select id from users where id_out='korvintag_109') where not exists (select * from keywords where id_out='korvintag_1419');
update keywords set name='Получение' where id_out='korvintag_1419';
insert into keywords (name, id_out, user_id, moderated) select 'Плато' , 'korvintag_1467', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_1467');
update keywords set name='Плато' where id_out='korvintag_1467';
insert into keywords (name, id_out, user_id, moderated) select 'Помеха' , 'korvintag_1526', (select id from users where id_out='korvintag_109'), (select id from users where id_out='korvintag_109') where not exists (select * from keywords where id_out='korvintag_1526');
update keywords set name='Помеха' where id_out='korvintag_1526';
insert into keywords (name, id_out, user_id, moderated) select 'Творец мира' , 'korvintag_1565', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_1565');
update keywords set name='Творец мира' where id_out='korvintag_1565';
insert into keywords (name, id_out, user_id, moderated) select 'Страдание' , 'korvintag_1600', (select id from users where id_out='korvintag_109'), (select id from users where id_out='korvintag_109') where not exists (select * from keywords where id_out='korvintag_1600');
update keywords set name='Страдание' where id_out='korvintag_1600';
insert into keywords (name, id_out, user_id, moderated) select 'Уверенность' , 'korvintag_1604', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_1604');
update keywords set name='Уверенность' where id_out='korvintag_1604';
insert into keywords (name, id_out, user_id, moderated) select 'Принятие' , 'korvintag_1685', (select id from users where id_out='korvintag_109'), (select id from users where id_out='korvintag_109') where not exists (select * from keywords where id_out='korvintag_1685');
update keywords set name='Принятие' where id_out='korvintag_1685';
insert into keywords (name, id_out, user_id, moderated) select 'Формирование' , 'korvintag_1805', (select id from users where id_out='korvintag_24'), (select id from users where id_out='korvintag_24') where not exists (select * from keywords where id_out='korvintag_1805');
update keywords set name='Формирование' where id_out='korvintag_1805';
insert into keywords (name, id_out, user_id, moderated) select 'Принцип' , 'korvintag_1872', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_1872');
update keywords set name='Принцип' where id_out='korvintag_1872';
insert into keywords (name, id_out, user_id, moderated) select 'Радость' , 'korvintag_1981', (select id from users where id_out='korvintag_85'), (select id from users where id_out='korvintag_85') where not exists (select * from keywords where id_out='korvintag_1981');
update keywords set name='Радость' where id_out='korvintag_1981';
insert into keywords (name, id_out, user_id, moderated) select 'Состояние' , 'korvintag_2077', (select id from users where id_out='korvintag_109'), (select id from users where id_out='korvintag_109') where not exists (select * from keywords where id_out='korvintag_2077');
update keywords set name='Состояние' where id_out='korvintag_2077';
insert into keywords (name, id_out, user_id, moderated) select 'Чудеса' , 'korvintag_2192', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_2192');
update keywords set name='Чудеса' where id_out='korvintag_2192';
insert into keywords (name, id_out, user_id, moderated) select 'Повторение' , 'korvintag_2200', (select id from users where id_out='korvintag_24'), (select id from users where id_out='korvintag_24') where not exists (select * from keywords where id_out='korvintag_2200');
update keywords set name='Повторение' where id_out='korvintag_2200';
insert into keywords (name, id_out, user_id, moderated) select 'Уважение' , 'korvintag_2235', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_2235');
update keywords set name='Уважение' where id_out='korvintag_2235';
insert into keywords (name, id_out, user_id, moderated) select 'Серьезность' , 'korvintag_2259', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_2259');
update keywords set name='Серьезность' where id_out='korvintag_2259';
insert into keywords (name, id_out, user_id, moderated) select 'Пробуждение' , 'korvintag_2261', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_2261');
update keywords set name='Пробуждение' where id_out='korvintag_2261';
insert into keywords (name, id_out, user_id, moderated) select 'Бестолковость' , 'korvintag_2262', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_2262');
update keywords set name='Бестолковость' where id_out='korvintag_2262';
insert into keywords (name, id_out, user_id, moderated) select 'Сердитость' , 'korvintag_2264', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_2264');
update keywords set name='Сердитость' where id_out='korvintag_2264';
insert into keywords (name, id_out, user_id, moderated) select 'Люди' , 'korvintag_2265', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_2265');
update keywords set name='Люди' where id_out='korvintag_2265';
insert into keywords (name, id_out, user_id, moderated) select 'Мгновение' , 'korvintag_2266', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_2266');
update keywords set name='Мгновение' where id_out='korvintag_2266';
insert into keywords (name, id_out, user_id, moderated) select 'Человек знания' , 'korvintag_2267', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_2267');
update keywords set name='Человек знания' where id_out='korvintag_2267';
insert into keywords (name, id_out, user_id, moderated) select 'Ясность' , 'korvintag_2268', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_2268');
update keywords set name='Ясность' where id_out='korvintag_2268';
insert into keywords (name, id_out, user_id, moderated) select 'Порабощение' , 'korvintag_2269', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_2269');
update keywords set name='Порабощение' where id_out='korvintag_2269';
insert into keywords (name, id_out, user_id, moderated) select 'Самоконтроль' , 'korvintag_2270', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_2270');
update keywords set name='Самоконтроль' where id_out='korvintag_2270';
insert into keywords (name, id_out, user_id, moderated) select 'Старость' , 'korvintag_2271', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_2271');
update keywords set name='Старость' where id_out='korvintag_2271';
insert into keywords (name, id_out, user_id, moderated) select 'Отступление' , 'korvintag_2272', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_2272');
update keywords set name='Отступление' where id_out='korvintag_2272';
insert into keywords (name, id_out, user_id, moderated) select 'Останов' , 'korvintag_2460', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_2460');
update keywords set name='Останов' where id_out='korvintag_2460';
insert into keywords (name, id_out, user_id, moderated) select 'Избавление' , 'korvintag_2476', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_2476');
update keywords set name='Избавление' where id_out='korvintag_2476';
insert into keywords (name, id_out, user_id, moderated) select 'Тяжелость' , 'korvintag_2481', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_2481');
update keywords set name='Тяжелость' where id_out='korvintag_2481';
insert into keywords (name, id_out, user_id, moderated) select 'Неуклюжесть' , 'korvintag_2482', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_2482');
update keywords set name='Неуклюжесть' where id_out='korvintag_2482';
insert into keywords (name, id_out, user_id, moderated) select 'Самодовольство' , 'korvintag_2483', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from keywords where id_out='korvintag_2483');
update keywords set name='Самодовольство' where id_out='korvintag_2483';
insert into keywords (name, id_out, user_id, moderated) select 'Покой' , 'korvintag_3752', (select id from users where id_out='korvintag_109'), (select id from users where id_out='korvintag_109') where not exists (select * from keywords where id_out='korvintag_3752');
update keywords set name='Покой' where id_out='korvintag_3752';
insert into keywords (name, id_out, user_id, moderated) select 'Настоящее' , 'korvintag_3754', (select id from users where id_out='korvintag_109'), (select id from users where id_out='korvintag_109') where not exists (select * from keywords where id_out='korvintag_3754');
update keywords set name='Настоящее' where id_out='korvintag_3754';
insert into keywords (name, id_out, user_id, moderated) select 'Петля обратной связи' , 'korvintag_4204', (select id from users where id_out='korvintag_24'), (select id from users where id_out='korvintag_24') where not exists (select * from keywords where id_out='korvintag_4204');
update keywords set name='Петля обратной связи' where id_out='korvintag_4204';
insert into sources (name, id_out, user_id, moderated) select 'Предисловие к книге Карлоса Кастанеды "Учение Дона Хуана: путь знания индейцев Яки"' , 'korvintag_4', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from sources where id_out='korvintag_4');
...
insert into sources (name, id_out, user_id, moderated) select 'Учение Дона Хуана: путь знания индейцев Яки' , 'korvintag_28', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from sources where id_out='korvintag_28');
update sources set name='Учение Дона Хуана: путь знания индейцев Яки' where id_out='korvintag_28';
insert into sources (name, id_out, user_id, moderated) select 'Отдельная реальность' , 'korvintag_318', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6') where not exists (select * from sources where id_out='korvintag_318');
update sources set name='Отдельная реальность' where id_out='korvintag_318';
insert into sources (name, id_out, user_id, moderated) select 'Сила настоящего' , 'korvintag_419', (select id from users where id_out='korvintag_109'), (select id from users where id_out='korvintag_109') where not exists (select * from sources where id_out='korvintag_419');
update sources set name='Сила настоящего' where id_out='korvintag_419';
insert into sources (name, id_out, user_id, moderated) select 'Ни сы. Восточная мудрость, которая гласит: будь уверен в своих силах и не позволяй сомнениям мешать тебе двигаться вперед' , 'korvintag_448', (select id from users where id_out='korvintag_24'), (select id from users where id_out='korvintag_24') where not exists (select * from sources where id_out='korvintag_448');
...
insert into sources (name, id_out, user_id, moderated) select 'Психология влияния' , 'korvintag_470', (select id from users where id_out='korvintag_24'), (select id from users where id_out='korvintag_24') where not exists (select * from sources where id_out='korvintag_470');
update sources set name='Психология влияния' where id_out='korvintag_470';
insert into sources (name, id_out, user_id, moderated) select 'Атомные привычки. Как приобрести хорошие привычки и избавиться от плохих' , 'korvintag_472', (select id from users where id_out='korvintag_24'), (select id from users where id_out='korvintag_24') where not exists (select * from sources where id_out='korvintag_472');
...
insert into sources (name, id_out, user_id, moderated) select 'Сэнсэй. Исконный Шамбалы' , 'korvintag_492', (select id from users where id_out='korvintag_85'), (select id from users where id_out='korvintag_85') where not exists (select * from sources where id_out='korvintag_492');
...
Вопрос - а почему бы при жизни не научиться воспринимать в широком диапазоне?', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6'), to_timestamp( '11.08.2022 17:24:24', 'DD.MM.YYYY HH24:MI:SS') where not exists (select * from sources where id_out='korvintag_260');
...
Т.е. нужна анализировать регулярно моменты творения нашим сознанием нашей реальности. К сожалению, это происходит бесконтрольно для нашего рационального сознаний.', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6'), to_timestamp( '11.08.2022 18:31:06', 'DD.MM.YYYY HH24:MI:SS') where not exists (select * from sources where id_out='korvintag_261');
...
Кроме того, проблема человека в противоречии между его телом и рассудком. Наверное целостность - это и есть состояние преодоления этого противоречия.', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6'), to_timestamp( '11.08.2022 20:46:57', 'DD.MM.YYYY HH24:MI:SS') where not exists (select * from sources where id_out='korvintag_264');
...
Тогда может открыться неизведанное.', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6'), to_timestamp( '11.08.2022 20:53:54', 'DD.MM.YYYY HH24:MI:SS') where not exists (select * from sources where id_out='korvintag_265');
...
Но тональю не исчерпывается человек. В нем есть и другая сущность — нагваль. Так Кастанеда называет часть нас самих, с которой мы вообще не вступаем в контакт. Это нечто, не имеющее определения (ни слов, ни имен, ни ощущений, ни значения), но тем не менее неотторжимый компонент нас самих. Можно оказаться свидетелем нагваля, но определить ее невозможно. Ее способно наблюдать только тело, отнюдь не разум. Нагваль обнаруживается в непостижимых проявлениях.' , 'Проявления Нагваля можно заметить только через тело. Через разум, тональ, нагваля не видно. Его как бы нет. Потому для доступа к Нагвалю нужно лучше изучить свое тело, и обращать внимание на его ощущения.', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6'), to_timestamp( '12.08.2022 10:35:11', 'DD.MM.YYYY HH24:MI:SS') where not exists (select * from sources where id_out='korvintag_270');
...
- во враждебном пятне тело особым образом реагирует
  ...
  - волосы дыбом на шее 
  - ноги подгинаются
  - пальцы сгинаются', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6'), to_timestamp( '12.08.2022 16:55:07', 'DD.MM.YYYY HH24:MI:SS') where not exists (select * from sources where id_out='korvintag_274');
...
— Ты попал в точку, дон Хуан. Но как мне измениться?' , 'Серьезность не должна быть привязана только к тому, что мы делаем. Серьезно нужно относиться и к тому, что происходит вне нас. Односторонняя серьезность порождает сильную усталость. Именно усталость не дает нам замечать чудеса.', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6'), to_timestamp( '11.08.2023 11:14:21', 'DD.MM.YYYY HH24:MI:SS') where not exists (select * from sources where id_out='korvintag_2252');
...
— Нет, я никогда ни на кого не сержусь. Никому из людей не удастся сделать что-то, достаточно для этого важное. На людей сердишься, когда веришь, что их поступки важны. Ничему подобному я больше не верю.' , 'Если ты сердишься на людей, то это значит, что ты веришь, что их поступки важны. А может стоить посомневаться в важности их поступков? Тогда и сердитость исчезнет?', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6'), to_timestamp( '11.08.2023 14:50:33', 'DD.MM.YYYY HH24:MI:SS') where not exists (select * from sources where id_out='korvintag_2257');
...
— Это произойдет мало-помалу, но страх исчезнет внезапно и быстро.' , 'Страх - первый враг на пути к знанию. При столкновении с ним нужно идти дальше, невзирая на страх. И он уйдет. И появится уверенность.', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6'), to_timestamp( '11.08.2023 16:32:42', 'DD.MM.YYYY HH24:MI:SS') where not exists (select * from sources where id_out='korvintag_2259');
...
Эту ошибку нужно преодолеть. Ни в коей мере не следует ей сдаваться.', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6'), to_timestamp( '11.08.2023 16:38:10', 'DD.MM.YYYY HH24:MI:SS') where not exists (select * from sources where id_out='korvintag_2260');
...
- отказывается от самого себя', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6'), to_timestamp( '11.08.2023 19:17:01', 'DD.MM.YYYY HH24:MI:SS') where not exists (select * from sources where id_out='korvintag_2262');
...
Можно избавиться от всех проблем. Для этого нужно перестать отгораживаться от окружающего мира и цепляться за собственные размышления.', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6'), to_timestamp( '31.08.2023 9:07:16', 'DD.MM.YYYY HH24:MI:SS') where not exists (select * from sources where id_out='korvintag_2498');
...
А в идеале нужно быть легким и текучим.', (select id from users where id_out='korvintag_6'), (select id from users where id_out='korvintag_6'), to_timestamp( '31.08.2023 10:07:43', 'DD.MM.YYYY HH24:MI:SS') where not exists (select * from sources where id_out='korvintag_2501');
...
Попасть в это состояние нам мешает разум, поскольку он очень громкий.', (select id from users where id_out='korvintag_109'), (select id from users where id_out='korvintag_109'), to_timestamp( '27.12.2023 18:38:34', 'DD.MM.YYYY HH24:MI:SS') where not exists (select * from sources where id_out='korvintag_3852');
