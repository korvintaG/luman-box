...
Вопрос - а почему бы при жизни не научиться воспринимать в широком диапазоне?', (select id from users where id_out='korvintag_6'), (select id from users where name='korvin'), to_timestamp( '11.08.2022 17:24:24', 'DD.MM.YYYY HH24:MI:SS') where not exists (select * from sources where id_out='korvintag_260');
...
И где границы этих миражей, точнее говоря границы перетворения своей жизни через изменение миражей?', (select id from users where id_out='korvintag_6'), (select id from users where name='korvin'), to_timestamp( '11.08.2022 18:41:05', 'DD.MM.YYYY HH24:MI:SS') where not exists (select * from sources where id_out='korvintag_262');
...
Тогда может открыться неизведанное.', (select id from users where id_out='korvintag_6'), (select id from users where name='korvin'), to_timestamp( '11.08.2022 20:53:54', 'DD.MM.YYYY HH24:MI:SS') where not exists (select * from sources where id_out='korvintag_265');
...
- во враждебном пятне тело особым образом реагирует
  ...
  - волосы дыбом на шее 
  - ноги подгинаются
  - пальцы сгинаются', (select id from users where id_out='korvintag_6'), (select id from users where name='korvin'), to_timestamp( '12.08.2022 16:55:07', 'DD.MM.YYYY HH24:MI:SS') where not exists (select * from sources where id_out='korvintag_274');
...
Иначе будут проблемы', (select id from users where id_out='korvintag_6'), (select id from users where name='korvin'), to_timestamp( '11.08.2023 12:22:25', 'DD.MM.YYYY HH24:MI:SS') where not exists (select * from sources where id_out='korvintag_2254');
...
— Это произойдет мало-помалу, но страх исчезнет внезапно и быстро.' , 'Страх - первый враг на пути к знанию. При столкновении с ним нужно идти дальше, невзирая на страх. И он уйдет. И появится уверенность.', (select id from users where id_out='korvintag_6'), (select id from users where name='korvin'), to_timestamp( '11.08.2023 16:32:42', 'DD.MM.YYYY HH24:MI:SS') where not exists (select * from sources where id_out='korvintag_2259');
...
Эту ошибку нужно преодолеть. Ни в коей мере не следует ей сдаваться.', (select id from users where id_out='korvintag_6'), (select id from users where name='korvin'), to_timestamp( '11.08.2023 16:38:10', 'DD.MM.YYYY HH24:MI:SS') where not exists (select * from sources where id_out='korvintag_2260');
...
- отказывается от самого себя', (select id from users where id_out='korvintag_6'), (select id from users where name='korvin'), to_timestamp( '11.08.2023 19:17:01', 'DD.MM.YYYY HH24:MI:SS') where not exists (select * from sources where id_out='korvintag_2262');
...
Нельзя сдаваться своей усталости!', (select id from users where id_out='korvintag_6'), (select id from users where name='korvin'), to_timestamp( '11.08.2023 20:21:09', 'DD.MM.YYYY HH24:MI:SS') where not exists (select * from sources where id_out='korvintag_2264');
insert into ideas (name, id_out, original_text, content, user_id, moderated, date_time_create) select 'Цель человека знания' , 'korvintag_2265' , 'Но если человек преодолеет свою усталость и проживет свою судьбу полностью — тогда его можно назвать человеком знания. Если хотя бы на одно краткое мгновение он отобьется от своего последнего, непобедимого врага! Этого мгновения ясности, силы и знания достаточно.' , 'Цель - мгновения ясности, силы и знания. Эти мгонвения стоят того, чтобы жить!', (select id from users where id_out='korvintag_6'), (select id from users where name='korvin'), to_timestamp( '11.08.2023 20:23:26', 'DD.MM.YYYY HH24:MI:SS') where not exists (select * from sources where id_out='korvintag_2265');
...
А в идеале нужно быть легким и текучим.', (select id from users where id_out='korvintag_6'), (select id from users where name='korvin'), to_timestamp( '31.08.2023 10:07:43', 'DD.MM.YYYY HH24:MI:SS') where not exists (select * from sources where id_out='korvintag_2501');
...
Попасть в это состояние нам мешает разум, поскольку он очень громкий.', (select id from users where id_out='korvintag_109'), (select id from users where name='korvin'), to_timestamp( '27.12.2023 18:38:34', 'DD.MM.YYYY HH24:MI:SS') where not exists (select * from sources where id_out='korvintag_3852');
...
Только задействуя концепты времени - прошлого и будущего. приходит страдание.', (select id from users where id_out='korvintag_109'), (select id from users where name='korvin'), to_timestamp( '06.01.2024 19:38:52', 'DD.MM.YYYY HH24:MI:SS') where not exists (select * from sources where id_out='korvintag_4038');
