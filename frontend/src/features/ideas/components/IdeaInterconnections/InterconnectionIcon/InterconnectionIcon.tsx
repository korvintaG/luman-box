...
import { InterconnestionPosition, InterconnectionTypeInfo } from '../../../../interconnections/InterconnectionTypes'; 
export type InterconnectionIconPropsUI = {
  cnt: number[];
  interconnectionTypeInfo: InterconnectionTypeInfo;
  URL: string;
}

export const InterconnectionIconUI: FC<InterconnectionIconPropsUI> = ({URL, 
