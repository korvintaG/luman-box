...
export const KeywordDetailsUI: FC<KeywordDetailsUIProps> = (
  props: KeywordDetailsUIProps,
) => {
  ...
  return (
    ...
    >
      ...
      <RecordButtonBlockUI
        ...
        deleteButtonCaption="Удалить ключевое слово"
      />
      <RelationListUI
