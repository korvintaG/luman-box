...
import { IdeaAttitudes, UserAttitudeIdea } from '../../../../utils/type';
...
import styles from "./attitude-idea.module.css";

export type AttitudeIdeaProps = {
    ideaID?:number;
    attitudes: IdeaAttitudes;
    setAttitudes?: (attitude:UserAttitudeIdea)=>void;
}

export const AttitudeIdea: FC<AttitudeIdeaProps> = ({ ideaID, attitudes, setAttitudes}) => {
    if (!ideaID || !attitudes) 
        return null;
