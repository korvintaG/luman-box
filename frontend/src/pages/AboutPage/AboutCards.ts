...
export const aboutCards: AboutCards[] = [
  {
    id: 1,
    text: 'Добро пожаловать в бесплатную публичную базу знаний  по саморазвитию, и связанным с ним гуманитарным наукам. Знания в базе организованы по <a href="/CMS/zettelkasten">методу ZettelKasten</a>. Дискуссии и ветвления знаний происходят по принципам,  изложенным <a href="/CMS/Mortimer_Adler">Мортимером Адлером</a>.',
    icon: BaseIcon,
    image: BaseImage,
  },
  {
